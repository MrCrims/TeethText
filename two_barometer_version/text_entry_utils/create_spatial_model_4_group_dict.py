...
def dict_to_json_write_file():
    dict = {}
    dict['1_a'] = 0.90; dict['1_b'] = dict['1_a']; dict['1_c'] = dict['1_a']; dict['1_d'] = dict['1_a']; dict['1_e'] = dict['1_a']; dict['1_f'] = dict['1_a']; dict['1_g'] = dict['1_a']; 
    dict['1_h'] = 0.10; dict['1_i'] = dict['1_h']; dict['1_j'] = dict['1_h']; dict['1_k'] = dict['1_h']; dict['1_l'] = dict['1_h']; dict['1_m'] = dict['1_h']; dict['1_n'] = dict['1_h']; 
    ...
    ##########################################################################
    dict['2_a'] = 0.05; dict['2_b'] = dict['2_a']; dict['2_c'] = dict['2_a']; dict['2_d'] = dict['2_a']; dict['2_e'] = dict['2_a']; dict['2_f'] = dict['2_a']; dict['2_g'] = dict['2_a']; 
    dict['2_h'] = 0.95; dict['2_i'] = dict['2_h']; dict['2_j'] = dict['2_h']; dict['2_k'] = dict['2_h']; dict['2_l'] = dict['2_h']; dict['2_m'] = dict['2_h']; dict['2_n'] = dict['2_h']; 
    ...
    dict['3_o'] = 0.90; dict['3_p'] = dict['3_o']; dict['3_q'] = dict['3_o']; dict['3_r'] = dict['3_o']; dict['3_s'] = dict['3_o']; dict['3_t'] = dict['3_o'];  
    dict['3_u'] = 0.10; dict['3_v'] = dict['3_u']; dict['3_w'] = dict['3_u']; dict['3_x'] = dict['3_u']; dict['3_y'] = dict['3_u']; dict['3_z'] = dict['3_u']; 
    ##########################################################################
    ...
    dict['4_o'] = 0.05; dict['4_p'] = dict['4_o']; dict['4_q'] = dict['4_o']; dict['4_r'] = dict['4_o']; dict['4_s'] = dict['4_o']; dict['4_t'] = dict['4_o'];  
    dict['4_u'] = 0.95; dict['4_v'] = dict['4_u']; dict['4_w'] = dict['4_u']; dict['4_x'] = dict['4_u']; dict['4_y'] = dict['4_u']; dict['4_z'] = dict['4_u']; 
    ##########################################################################

    print(dict) 
    with open('spatial_model_4_group_dict.json', 'w') as f:
        json.dump(dict, f)  
